...
import static com.reactlibrary.R.drawable.ic_phonelink_ring_white_24dp;
import static com.reactlibrary.R.drawable.ic_volume_up_white_24dp;
...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.TWILIO_ACCESS_TOKEN = getIntent().getStringExtra("TWILIO_TOKEN");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.menu_settings) {
            ...
            return true;
        } else if (i == R.id.speaker_menu_item) {
...
//                R.drawable.ic_video_call_white_24dp));
    ...
    private EncodingParameters getEncodingParameters() {
        final int maxAudioBitrate = Integer.parseInt(
                preferences.getString("sender_max_audio_bitrate", "0"));
        final int maxVideoBitrate = Integer.parseInt(
                preferences.getString("sender_max_video_bitrate", "0"));
...
//        connectDialog.show();
    ...
    private View.OnClickListener micActionClickListener() {
        return new View.OnClickListener(){
            @Override
            public void onClick(View v) {
